...
export default function EditBlogPostPage() {
  ...
  const loadPost = async () => {
    try {
      setLoading(true);
      const posts =
        (await BlogService.blogControllerGetMyPosts()) as BlogPost[];
      ...
      setFormData({
        ...
        category:
          (post.category as CreatePostDto.category) ||
          CreatePostDto.category.OTHER,
        tags: post.tags || [],
        commentsEnabled: post.commentsEnabled ?? true,
      });
    } catch (error) {
      console.error("[Publisher] Error loading post:", error);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      await BlogService.blogControllerUpdatePost(
        postId,
        formData as unknown as UpdatePostDto,
      );
      toast.success("Article mis à jour avec succès");
      router.push("/publisher/blog");
    } catch (error) {
      console.error("[Publisher] Error updating post:", error);
