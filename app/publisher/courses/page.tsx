                    ...
                    <div className="container mx-auto max-w-7xl">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p className="text-muted-foreground">Gérez vos cours et formations</p>
                            </div>
                            <Button asChild>
                        ...
                        {loading ? (
                            ...
                            <Card>
                                <CardContent className="py-12 text-center">
                                    <p className="text-muted-foreground mb-4">Vous n'avez pas encore de cours</p>
                                    <Button asChild>
                                        <Link href="/publisher/courses/new">
                                            <Plus className="mr-2" />
                                    ...
                                    <Card key={course.id}>
                                        <CardHeader>
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                {course.isFree && <Badge className="bg-green-500">Gratuit</Badge>}
                                            </div>
                                        ...
                                        <CardContent>
                                            <div className="flex items-center justify-between text-sm text-muted-foreground">
                                                ...
                                                <span>{course.isFree ? "Gratuit" : `${course.price}€`}</span>
                                            </div>
                                        </CardContent>
