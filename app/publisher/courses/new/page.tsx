...
export default function NewCoursePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setLoading(true)
            await LessonsService.lessonsControllerCreateLesson(formData)
            toast.success("Cours créé avec succès")
            router.push("/publisher/courses")
        } catch (error) {
            console.error("[Publisher] Error creating course:", error)
                ...
                <main className="flex-1 pt-24 pb-12 px-4 lg:px-8">
                    <div className="container mx-auto max-w-4xl">
                        <div className="mb-8">
                            ...
                            <h1 className="text-4xl font-bold">Nouveau Cours</h1>
                        </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(value) => setFormData({ ...formData, level: value as CreateLessonDto.level })}
                                            >
                                                <SelectTrigger>
                                                    <SelectValue />
                                                </SelectTrigger>
                                                <SelectContent>
                                                    <SelectItem value={CreateLessonDto.level.BEGINNER}>Débutant</SelectItem>
                                                    <SelectItem value={CreateLessonDto.level.INTERMEDIATE}>Intermédiaire</SelectItem>
                                                    <SelectItem value={CreateLessonDto.level.ADVANCED}>Avancé</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
