        ...
        <div className="container mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
              Rencontrez les experts passionnés qui travaillent chaque jour pour vous offrir la meilleure expérience
              d'apprentissage
            </p>
          </div>
            ...
            <CardContent className="p-8 lg:p-12">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-balance">
                  Notre mission : démocratiser l'accès à l'éducation de qualité
                </h2>
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Chez EduLearn, nous croyons que chacun mérite d'avoir accès à une éducation de qualité, peu importe sa
                  localisation ou son parcours. Notre équipe multidisciplinaire combine expertise pédagogique,
                  innovation technologique et créativité pour créer des expériences d'apprentissage exceptionnelles.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Nous sommes unis par une passion commune : aider nos apprenants à atteindre leurs objectifs et à
                  transformer leur avenir professionnel.
                </p>
              </div>
            </CardContent>
          </Card>
