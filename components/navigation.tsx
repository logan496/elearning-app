...
import { Menu, X, LogOut, LayoutDashboard, Shield, ChevronDown, User, Briefcase } from 'lucide-react'
              ...
              {isAuthenticated && (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                      ...
                      <DropdownMenuItem asChild>
                        <Link href="/profile?tab=applications" className="w-full cursor-pointer">
